...
def test_model(model, dataset):
    ...
    return tot_loss/len(dataset.dataset), np.sqrt(metrics.mean_squared_error(true_labels, labels))
...
#     pass
    ...
    # file_data.close()
# except IOError:
data, no_labels, all_labels = load_number_dataset(data_file, 'smiles', Chem.MolFromSmiles, mgf, 'exp')
data = np.array(data)
for graph in data:
