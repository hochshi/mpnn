...
from mpnn_functions import EdgeNetwork, AdjMsgAgg, GRUUpdate, GraphLevelOutput
...
class Encoder(nn.Module):
    ...
    def encode(self, afm, bfm, adj, mask):
    ...
    def forward(self, afm, bfm, adj, mask):
        ...
        """
        enc_graph = self.encode(afm, bfm, adj, mask)
